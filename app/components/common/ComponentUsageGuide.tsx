...
export default function ComponentUsageGuide() {
  return (
    <div className="min-h-screen bg-white dark:bg-[#1d1d1d] py-16">
      <div className="container max-w-4xl mx-auto px-4 space-y-12">
        ...
        <div className="space-y-12">
          {/* Example 1 */}
          <div className="space-y-4 p-6 bg-gray-50 dark:bg-[#2a2a2a] rounded-lg">
            <h2 className="text-xl font-bold text-gray-900 dark:text-white">
              #1 Basic Divider with Text
            </h2>
            <div className="bg-white dark:bg-[#1d1d1d] p-4 rounded">
              <Divider>Section Title Here</Divider>
            </div>
            <code className="block bg-gray-900 dark:bg-black text-green-400 p-4 rounded text-sm overflow-x-auto">
              {`<Divider>Section Title Here</Divider>`}
            </code>
          </div>
          ...
          <div className="space-y-4 p-6 bg-gray-50 dark:bg-[#2a2a2a] rounded-lg">
            ...
            <code className="block bg-gray-900 dark:bg-black text-green-400 p-4 rounded text-sm">
              {`<Divider />`}
            </code>
          </div>
          ...
          <div className="space-y-4 p-6 bg-gray-50 dark:bg-[#2a2a2a] rounded-lg">
            ...
            <div className="bg-white dark:bg-[#1d1d1d] p-4 rounded">
              <Divider
                lineColor="border-primary dark:border-blue-400"
...
>
  CUSTOM STYLED
        ...
        <div className="space-y-4 p-6 bg-gray-50 dark:bg-[#2a2a2a] rounded-lg">
          ...
          <code className="block bg-gray-900 dark:bg-black text-green-400 p-4 rounded overflow-x-auto">
            {`import Divider from "@/app/components/common/Divider";`}
          </code>
        </div>
      </div>
