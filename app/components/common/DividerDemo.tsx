...
export default function DividerDemo() {
  return (
    <div className="min-h-screen bg-[#1d1d1d] py-24">
      <div className="container max-w-6xl mx-auto px-4 space-y-16">
        ...
        <div className="space-y-4">
          <h2 className="text-2xl font-bold text-white">Default Divider</h2>
          <Divider>What Is EggMpire Token (EGGS)</Divider>
        </div>

        {/* Example 2: No Text */}
        <div className="space-y-4">
          <h2 className="text-2xl font-bold text-white">Simple Line Divider</h2>
          <Divider />
        </div>

        {/* Example 3: Large Spacing */}
        <div className="space-y-4">
          <h2 className="text-2xl font-bold text-white">Large Spacing</h2>
          <Divider spacing="lg">FEATURES & BENEFITS</Divider>
        </div>

        {/* Example 4: Small Spacing */}
        <div className="space-y-4">
          <h2 className="text-2xl font-bold text-white">Small Spacing</h2>
          <Divider spacing="sm">or</Divider>
        </div>

        {/* Example 5: Custom Colors */}
        <div className="space-y-4">
          <h2 className="text-2xl font-bold text-white">Custom Colors</h2>
        ...
        <div className="space-y-6 bg-[#2a2a2a] p-8 rounded-lg">
          <h2 className="text-2xl font-bold text-white">In Context</h2>
